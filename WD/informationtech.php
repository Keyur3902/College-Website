  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="informationtech.php">Information Technology Department</a>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">  
              <div class="carousel-item active">
                <img src="assets\pexels-luis-gomes-546819 (1).jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="assets\pexels-fauxels-3183149 (1).jpg" class="d-block w-100 img2" alt="...">
              </div>
              <div class="carousel-item">
                <img src="assets\pexels-fauxels-3183197 (1).jpg" class="d-block w-100" alt="...">
              </div>
...
<ul class="vision_mission_list" style = "margin:64px;">
					...
					<li><b>Individual and team work:</b> Function effectively as
					...
					<li><b>Life-long learning:</b> Recognize the need for, and
